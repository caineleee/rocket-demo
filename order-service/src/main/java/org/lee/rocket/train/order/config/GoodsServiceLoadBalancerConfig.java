 ...
 * Spring Cloud 会为它创建独立的子上下文，只对 goods-service 生效。
 * <p>
 * 【与 Dubbo 负载均衡的对比】
 ...
 *   示例位置：GoodsFeignClient 的 @FeignClient 注解
 */
public class GoodsServiceLoadBalancerConfig {
    ...
    public ReactorLoadBalancer<ServiceInstance> randomLoadBalancer(
        ...
        // 1. 获取服务名（即 @FeignClient(name = "goods-service") 中的 "goods-service"）
